...
test('toggleActiveDegreeIds will take a DegreeId and add it to an ActiveDegreeIds which doesn\'t already have the Id in it', () => {
  ...
  const actualActiveDegreeIds = toggleActiveDegreeIds(degreeId, activeDegreeIds)

  expect(actualActiveDegreeIds).toEqual(expectedActiveDegreeIds)
})

test('toggleActiveDegreeIds will take a DegreeId and remove it from an ActiveDegreeIds which only has that Id in it', () => {
...
test('toggleActiveDegreeIds will take a DegreeId and remove it from the end of an ActiveDegreeIds which does already have the Id in it', () => {
...
test('toggleActiveDegreeIds will take a DegreeId and remove it from the start of an ActiveDegreeIds which does already have the Id in it', () => {
...
test('toggleActiveDegreeIds will take a DegreeId and remove it from the middle of an ActiveDegreeIds which does already have the Id in it', () => {
